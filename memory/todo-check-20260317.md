...
- [ ] **4H.2** 继续推进 PR #227 小修线
- [ ] **4H.3** 定义 PR-A：CLI runner hardening scope
- [ ] **4H.4** 起草 PR-B：strict fallback（contract-safe）
- [ ] **4H.5** 决策：新工具 vs behind flag
- [ ] **4H.6** 整理 upstream-safe evidence pack + 两步走计划

---

## 💡 建议

- 📅 有 27 个待完成的 P1 任务需要本周推进

---

**报告路径**: /Users/lucifinil_chen/.openclaw/workspace/memory/todo-check-20260317.md
